    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          <div className="hidden lg:block absolute top-16 left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-brand-blue/20 via-brand-green/20 to-rose-500/20" />
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="relative inline-flex mb-6">
                ...
                <span className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-white shadow-md flex items-center justify-center text-xs font-bold text-brand-dark">
                  {step.number}
                </span>
              </div>
